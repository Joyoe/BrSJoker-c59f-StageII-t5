...
import com.brightsight.joker.core.model.su.JoJoPolicy.Companion.INTERACTIVE
import com.brightsight.joker.ktx.getLabel

data class JoJoPolicy(
    var uid: Int,
...
fun Map<String, String>.toPolicy(pm: PackageManager): JoJoPolicy {
...
@Throws(PackageManager.NameNotFoundException::class)
fun Int.toPolicy(pm: PackageManager, policy: Int = INTERACTIVE): JoJoPolicy {
