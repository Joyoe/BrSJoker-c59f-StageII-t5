...
- Fix toggling app components in JokerHide screen
- Update translations
...
- Support per-application component granularity JokerHide targets (only on v19+)
...
- Fix crashes when entering JokerHide section on some devices
...
- Hidden apps are now shown on the top of the list in JokerHide fragment
...
- Remove app from JokerHide list if uninstalled
...
- Using new joyoeprop tool to properly detect JokerHide status
...
- Controls JokerHide initialization
- Add disable button
