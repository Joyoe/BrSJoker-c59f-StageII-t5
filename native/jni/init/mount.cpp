...
void JokerInit::mount_rules_dir(const char *dev_base, const char *mnt_base) {
    char path[128];
...
void JokerInit::setup_tmp(const char *path) {
    ...
    close(fd);
    fd = xopen("jokerinit", O_WRONLY | O_CREAT, 0755);
    ...
    xsymlink("./jokerinit", "jokerpolicy");
    xsymlink("./jokerinit", "jojopolicy");
