...
void FirstStageInit::prepare() {
    if (cmd->force_normal_boot) {
        ...
        rename("/init" /* jokerinit */, FSR "/system/bin/init");
        ...
        rename("/init" /* jokerinit */ , "/system/bin/init");
        rename("/.backup/init", "/init");
    }
...
void SARInit::first_stage_prep() {
    ...
    // Replace redirect init with jokerinit
    dest = xopen("/dev/jokerinit", O_CREAT | O_WRONLY, 0);
    ...
    xmount("/dev/jokerinit", REDIR_PATH, nullptr, MS_BIND, nullptr);
